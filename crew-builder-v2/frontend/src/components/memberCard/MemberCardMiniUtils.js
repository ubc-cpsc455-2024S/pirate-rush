...
export const handleUpgradeMember = async (crewMember, player, dispatch, setIsEvolving, setIsSilhouette) => {
...
const evolveMember = async (playerId, crewMember, dispatch, setIsEvolving, setIsSilhouette) => {
